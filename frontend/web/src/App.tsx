  ...
  return (
    <main className="workspace">
      ...
      <section className="grid">
        ...
        />
        <VideoPanel previewUrl={assessment.previewUrl} diagnosis={assessment.diagnosis} error={error} />
        <ResultsPanel diagnosis={assessment.diagnosis} onDownload={assessment.downloadReport} />
      </section>
    </main>
  )
}
